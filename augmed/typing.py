...
Range2PerAxis = Number | Tuple[Number, Number] | Tuple[Number, ...] | Float32[np.ndarray | torch.Tensor, "2 | 2 * <dim>"]
Range4PerAxis = Number | Tuple[Number, Number, Number, Number] | Tuple[Number, ...] | Float32[np.ndarray | torch.Tensor, "4 | 4 * <dim>"]
